		...
		<tr>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					RUC: 3518733-6
					<br>
					Dirección: CALLE STO. TOMAS  NRO. 520 -LUQUE PARAGUAY
				</div>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					Teléfono: 0983386288
					<br>
					galeanoantonio6@gmail.com
				</div>

			</td>
			<td style="background-color:white; width:110px; text-align:center; color:red"><br><br>FACTURA N.<br>$factura</td>
